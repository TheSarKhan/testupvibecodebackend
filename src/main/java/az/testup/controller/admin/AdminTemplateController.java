...
public class AdminTemplateController {
    ...
    @PatchMapping("/templates/{id}/toggle-visibility")
    public ResponseEntity<TemplateResponse> toggleVisibility(@PathVariable Long id) {
        TemplateResponse resp = templateService.toggleVisibility(id);
        auditLogService.logCurrent(AuditAction.TEMPLATE_UPDATED, "TEMPLATE", resp.title(),
                resp.visible() ? "Göstərildi" : "Gizlədildi");
        return ResponseEntity.ok(resp);
    }
